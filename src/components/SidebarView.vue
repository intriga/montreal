      ...
      <div class="social-count-plus">
        <ul class="default">
          <li class="count-facebook">
            ...
            ></a
            ><span class="items"
              ><span class="count">20.5k</span><span class="label">likes</span></span
            >
          </li>
          <li class="count-instagram">
            ...
            ></a
            ><span class="items"
              ><span class="count">20.5k</span><span class="label">followers</span></span
            >
          </li>
          ...
          <li class="count-youtube">
            <a class="icon" href="#" rel="nofollow noopener noreferrer" target="_blank"></a
            ><span class="items"
              ><span class="count">20.5k</span><span class="label">subscribers</span></span
            >
          </li>
      ...
      <div class="wrapper_category_image">
        <div class="category_image_wrapper_main">
          <div
            ...
            style="
              background-image: url('http://jellywp.com/theme/disto/demo/wp-content/uploads/2019/02/annie-spratt-70918-unsplash-400x280.jpg');
            "
          >
            <a class="category_image_link" id="category_color_2" href="#"
              ><span class="jl_cm_overlay"
                ><span class="jl_cm_name">Active</span><span class="jl_cm_count">11</span></span
              ></a
            >
          ...
          <div
            class="category_image_bg_image"
            style="
              background-image: url('http://jellywp.com/theme/disto/demo/wp-content/uploads/2019/02/soroush-karimi-253940-unsplash-400x280.jpg');
            "
          >
            <a class="category_image_link" id="category_color_3" href="#"
              ><span class="jl_cm_overlay"
                ><span class="jl_cm_name">Business</span><span class="jl_cm_count">10</span></span
              ></a
            >
          ...
          <div
            class="category_image_bg_image"
            style="
              background-image: url('http://jellywp.com/theme/disto/demo/wp-content/uploads/2019/02/pexels-photo-1003816-400x280.jpeg');
            "
          >
            <a class="category_image_link" id="category_color_4" href="#"
              ><span class="jl_cm_overlay"
                ><span class="jl_cm_name">Crazy</span><span class="jl_cm_count">5</span></span
              ></a
            >
        ...
        <div>
          <ul class="feature-post-list recent-post-widget">
            <li>
              ...
              <div class="item-details">
                <span class="meta-category-small"
                  ><a class="post-category-color-text" style="background: #d800f9" href="#"
                    >Techno</a
                  ></span
                >
                <h3 class="feature-post-title">
                  <a href="#"> Sitting right here waiting for you come to me</a>
                </h3>
            ...
            <li>
              ...
              <div class="item-details">
                <span class="meta-category-small"
                  ><a class="post-category-color-text" style="background: #ed1c1c" href="#"
                    >Active</a
                  ></span
                >
                <h3 class="feature-post-title">
                  <a href="#"> Before breakfast we have a great photo shoot</a>
                </h3>
                <span class="post-meta meta-main-img auto_image_with_date">
                  <span class="post-date"><i class="fa fa-clock-o"></i>Dec 23, 2016</span></span
                >
              </div>
            </li>
            <li>
              ...
              <div class="item-details">
                ...
                >
                <h3 class="feature-post-title">
                  <a href="#"> Beautiful flying bikes with simple style but look good</a>
                </h3>
                <span class="post-meta meta-main-img auto_image_with_date">
                  <span class="post-date"><i class="fa fa-clock-o"></i>Dec 23, 2016</span></span
                >
      ...
      <div class="slider_widget_post jelly_loading_pro">
        <div class="recent_post_large_widget">
          <span
            ...
            style="
              background-image: url('http://jellywp.com/theme/disto/demo/wp-content/uploads/2018/11/marvin-tolentino-680683-unsplash-380x350.jpg');
            "
          ></span>
          <a
            href="#"
          ...
          <div class="wrap_box_style_main image-post-title">
            <h3 class="image-post-title">
              <a href="#"> Standing right here and singing until the mid</a>
            </h3>
            <span class="jl_post_meta"
              ><span class="jl_author_img_w"
                ><img
                  src="../public/js/favicon.jpg"
                  width="30"
                  height="30"
                  alt="Anna Nikova"
        ...
        <div class="recent_post_large_widget">
          <span
            class="image_grid_header_absolute"
            style="
              background-image: url('http://jellywp.com/theme/disto/demo/wp-content/uploads/2016/12/bartosz-wanot-133401-unsplash-380x350.jpg');
            "
          ></span>
          <a
            href="#"
          ...
          <div class="wrap_box_style_main image-post-title">
            <h3 class="image-post-title">
              <a href="#"> You can make your art with canyon color</a>
            </h3>
            <span class="jl_post_meta"
              ><span class="jl_author_img_w"
                ><img
        ...
        <div class="recent_post_large_widget">
          <span
            class="image_grid_header_absolute"
            style="
              background-image: url('http://jellywp.com/theme/disto/demo/wp-content/uploads/2019/03/banter-snaps-1438384-unsplash-380x350.jpg');
            "
          ></span>
          <a
            href="#"
          ...
          <div class="wrap_box_style_main image-post-title">
            <h3 class="image-post-title">
              <a href="#"> Makeup it really important things to do</a>
            </h3>
            <span class="jl_post_meta"
              ><span class="jl_author_img_w"
                ><img
